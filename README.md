...
<title>Yukarı / Aşağı Git Butonları</title>
<style>
  /* Sayfa uzun olsun diye örnek */
  body {
    height: 2000px;
...
<body>
  ...
  <div class="scroll-buttons">
    <button id="toTop">↑ Yukarı Git</button>
    <button id="toBottom">↓ Aşağı Git</button>
  </div>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Ararat Mimarlık</title>
<style>
/* Temel Reset */
* { margin: 10px; padding:0; box-sizing:border-box; font-family: 'Times New Roman', Times, serif, sans-serif; }
body { background-color:#ca5858; color:#fff; scroll-behavior: smooth; }
a { color:#00f; text-decoration:none; }
a:hover { text-decoration:underline; }

/* Menü */
nav { position:fixed; top:0; width:100%; background-color:#e50000; padding:10px 0; z-index:1000; display:flex; align-items:center; justify-content:center; gap:30px; }
nav img { height:50px; margin-right:20px; }
nav ul { list-style:none; display:flex; gap:30px; align-items:center; }
nav ul li a { color:#fff; font-weight:bold; padding:5px 10px; transition:0.3s; }
nav ul li a:hover { color:#f00; }

/* Bölümler */
section { padding:100px 20px; min-height:100vh; }
#anasayfa { display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center; background-color:#7a788afe; }
#anasayfa h1 { font-size:3em; margin-bottom:20px; color:#f00; }
#anasayfa p { font-size:1.5em; margin-bottom:30px; color:#fff; }
.btn { background-color:#f00; color:#faea42d4; padding:12px 25px; border:none; cursor:pointer; font-size:1em; transition:0.3s; border-radius:5px; }
.btn:hover { background-color:#fff; color:#f00; }

/* Hakkımızda & Hizmetler & Projeler */
h2 { font-size:2em; margin-bottom:20px; color:#f00; text-align:center; }
.hizmetler-grid, .projeler-grid { display:flex; flex-wrap:wrap; gap:20px;margin: 10px; justify-content:center; }
.hizmetler-grid div, .projeler-grid div { background-color:#c40000; padding:20px; border-radius:10px; flex:1 1 250px; text-align:center; margin:10px; transition:0.3s; }
.hizmetler-grid div:hover, .projeler-grid div:hover { background-color:#bd0000; margin: 5px; transform:translateY(-5px); }
...
input[type="submit"] { background-color:#f00; color:#fff; cursor:pointer; font-weight:bold; }
input[type="submit"]:hover { background-color:#fff; color:#f00; }

/* Responsive */
    
@media(max-width:768px){ nav ul { flex-direction:column; align-items:center;padding: 10px 0; } nav img { margin-bottom:10px;height: 40px;}nav ul { flex-direction: column;  gap:15px; } }
@media(max-width:768px){ form { width: 100%;padding: 0 10px; } input, textarea { width: 100%; } }
@media(max-width:768px){ #anasayfa h1{ font-size: 2.5em; } 
                        #anasayfa p{ font-size: 1.2em; } .btn{padding: 10px 20px; font-size: 0.9em;} }
@media(max-width:768px)                        
{ .hizmetler-grid div, .projeler-grid div { flex:1 1 100%; } }
</style>
</head>
<body>
    <script src="https://jiyanmsi575-creator.github.io/erbenmuhendislik/index.html"></script>
...
<nav>
    ...
    <img src="https://github.com/dahresoo/araratmimarlik/blob/main/6f36ccab-5a69-4ae9-a4d6-8ba4be72b5e3.jpg" alt="Ararat Mimarlık Logo"
...
<head>
    ...
    <style>
        ...
        /* Tüm başlıkları (h1, h2, h3, vb.) sola hizala */
...
<body>
    ...
    <div class="hakkimizda-metin-kutusu">
        ...
        <h2>🏗️ Yapım Mimarisi: Geleceğin Yaşam Alanlarını İnşa Etmek</h2>
